# This Makefile is for the X86::Udis86 extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/X86/Udis86.pm]
#     AUTHOR => q[Bob Wilkinson <bob@>]
#     BUILD_REQUIRES => {  }
#     DEFINE => q[]
#     INC => q[-I.]
#     LIBS => [q[-ludis86]]
#     NAME => q[X86::Udis86]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/X86/Udis86.pm]
...
PARENT_NAME = X86
DLBASE = $(BASEEXT)
VERSION_FROM = lib/X86/Udis86.pm
INC = -I.
DEFINE = 
...
H_FILES  = ppport.h
MAN1PODS = 
MAN3PODS = lib/X86/Udis86.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/X86
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/X86
...
TO_INST_PM = lib/X86/Udis86.pm

PM_TO_BLIB = lib/X86/Udis86.pm \
	blib/lib/X86/Udis86.pm
...
# X86::Udis86 might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/X86/Udis86.pm $(INST_MAN3DIR)/X86::Udis86.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               X86-Udis86' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for blah blah blah' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Bob Wilkinson <bob@>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Bob Wilkinson &lt;bob@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/X86/Udis86.pm blib/lib/X86/Udis86.pm 
